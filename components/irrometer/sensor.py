...
from esphome.const import (
    CONF_ID,
    CONF_TEMPERATURE,
    # CONF_RESISTANCE is not a built-in constant, so we remove it from imports
    # CONF_VOLTAGE is not used, so it's removed for cleanliness
...
# This allows users to enable/disable sensors and give them custom names
WM_SCHEMA = cv.Schema(
    {
